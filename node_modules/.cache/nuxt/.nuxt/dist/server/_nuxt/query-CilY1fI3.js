import { defineComponent, shallowRef, getCurrentInstance, provide, cloneVNode, h, createElementBlock, computed, toValue, onServerPrefetch, ref, toRef, nextTick, unref } from "vue";
import { debounce } from "/home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/nuxt/node_modules/perfect-debounce/dist/index.mjs";
...
import { withBase, withLeadingSlash, joinURL, withoutTrailingSlash } from "/home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/ufo/dist/index.mjs";
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import("./client-db-BSnpy3aw.js").then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-CilY1fI3.js.map

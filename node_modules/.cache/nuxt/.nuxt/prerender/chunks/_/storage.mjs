import { prefixStorage } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/unstorage/dist/index.mjs';
import { isRelative, joinURL, withLeadingSlash, withoutTrailingSlash } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/ufo/dist/index.mjs';
...
import { extname } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/pathe/dist/index.mjs';
import { camelCase } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/scule/dist/index.mjs';
...
import { toString } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/micromark/index.js';
import { stringifyPosition } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/micromark-util-character/index.js';
import { push, splice } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/micromark-util-chunked/index.js';
import { resolveAll } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/micromark-util-resolve-all/index.js';
...
import { parseFrontMatter } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/remark-mdc/dist/index.mjs';
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);

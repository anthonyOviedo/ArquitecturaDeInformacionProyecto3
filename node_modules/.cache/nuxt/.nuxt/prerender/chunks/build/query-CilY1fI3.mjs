import { computed, toValue, getCurrentInstance, onServerPrefetch, ref, shallowRef, toRef, nextTick, unref, defineComponent, provide, cloneVNode, h, createElementBlock } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/vue/index.mjs';
import { debounce } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/nuxt/node_modules/perfect-debounce/dist/index.mjs';
...
import { withBase, withLeadingSlash, joinURL, withoutTrailingSlash } from 'file:///home/tony/proyectos/ArquitecturaDeInformacionTarea4/node_modules/ufo/dist/index.mjs';
...
function createAsyncData(nuxtApp, key, _handler, options, initialCachedData) {
  ...
  const handler = !nuxtApp.ssrContext?._sharedPrerenderCache ? _handler : () => {
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BSnpy3aw.mjs').then((m) => m.useContentDatabase());
